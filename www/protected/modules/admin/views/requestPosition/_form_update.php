...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<?php echo $form->errorSummary($model); ?>        
        ...
        <div class="row">
                ...
                <?php echo $form->dropDownList($model,'id_address', Address::getAll()); ?> 
                <?php echo $form->error($model,'id_address'); ?>
        </div>

        <div class="row">
                <?php echo $form->labelEx($model,'deleted'); ?>
                <?php echo $form->dropDownList($model,'deleted',array(0=>'Доступен',1=>'Удалён')); ?>
                <?php echo $form->error($model,'deleted'); ?>
        </div>

        <div class="row">
                <?php echo $form->labelEx($model,'amount'); ?>
                <?php echo $form->textField($model,'amount', array('style'=>'width: 50px;')); ?>
